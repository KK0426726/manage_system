...
function verifyFun(width, height, hsize, size, diff) {
//width:块宽，height:块高，hsize:文字大小，size:滑动块箭头字体大小,diff:误差值
	...
	verifyBox.style.width = parseInt(width) + 'px';
	verifyBox.style.height = parseInt(height) + 'px';
	verifyDom.style.lineHeight = parseInt(height) + 'px';
	verifyDom.style.fontSize = parseInt(size) + 'px';
	verifyDom.style.width = parseInt(height) + 'px';

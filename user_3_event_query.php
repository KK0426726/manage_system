...
$sq="SELECT * FROM stu WHERE user_no='$nowuser_no'";
...
<head>
    ...
    <title>用户系统</title>
    <link rel="stylesheet" href="user_3_event_query.css">
    ...
    <div class="body">
        <div class="box">
            <div class="subnav" id="subnav">
                ...
                <div><a href="user_3_event_query.php" class="subnavlink_selected">查看活动</a></div>
...
foreach($data as $value){
    ...
    $sq="SELECT * FROM `bm_".$arr['teach_no']."` WHERE user_no='$nowuser_no'";
    $result=mysqli_query($conn,$sq);
    $da=mysqli_fetch_row($result);
    if($da){echo"<td>已报名</td>";}
  
    else{echo "<td><a href='user_3_action_sign_up.php?teach_no={$arr['teach_no']}'>报名</a></td>";}
   if($da){echo"<td><a href='user_3_action_cancel.php?teach_no={$arr['teach_no']}'>取消报名</a></td>";}
   else{echo"<td>不可操作</td>";}
}
}

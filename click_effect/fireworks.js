function createFireworks(t = {
    ...
    function d(e, i) {
        ...
        n.endPos = (a = n, e = anime.random(0, 360) * Math.PI / 180, i = anime.random(t.diffuseRadius.min, t.diffuseRadius.max), i = [ - 1, 1][anime.random(0, 1)] * i, {
            x: a.x + i * Math.cos(e),
            y: a.y + i * Math.sin(e)
        }),
        n.draw = function() {
    ...
    function s(i) {
        for (let e = 0; e < i.animatables.length; e++) i.animatables[e].target.draw()
    }
    function u(i, n) {
        var e = function(e, i) {
            let n = {};
        ...
        let a = [];
        for (let e = 0; e < t.numberOfParticules; e++) a.push(d(i, n));
        anime.timeline().add({
            targets: a,
            x(e) {
                return e.endPos.x

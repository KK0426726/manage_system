 ...
 */
 ...
 function(e) {
     ...
     function i(e, t, r) {
         ...
         for (var n, a, u = /uniform (\w+) (\w+)/g,
         h = e + t; null != (n = u.exec(h));) a = n[2],
 ...
 default:
     ...
     h = function() {
         ...
         for (var a = null,
         u = 0; u < i.length; u++) if (s.texImage2D(s.TEXTURE_2D, 0, s.RGBA, 32, 32, 0, s.RGBA, i[u].type, null), s.framebufferTexture2D(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0, s.TEXTURE_2D, o, 0), s.checkFramebufferStatus(s.FRAMEBUFFER) === s.FRAMEBUFFER_COMPLETE) {
             a = i[u];
             break
         }
         return a
     ...
     var d = function(t, r) {
         ...
         u = a ? new a(this.resolution * this.resolution * 4) : null, c = 0; c < 2; c++) {
     ...
     d.prototype = {
         setupPointerEvents: function() {
             ...
             function(e) {
                 for (var r = e.originalEvent.changedTouches,
     ...
     e.fn.ripples = function(t) {
         ...
         return this.each(function() {
             ...
             o = i.data("ripples"),
             n = e.extend({},
             d.DEFAULTS, i.data(), "object" == typeof t && t); (o || "string" != typeof t) && (o ? "string" == typeof t && d.prototype[t].apply(o, r) : i.data("ripples", o = new d(this, n)))
         })
     },

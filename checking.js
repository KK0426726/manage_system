...
function switcher_change_1() {
    ...
    document.getElementById("gender_div").className = "gender_hide";
...
function judgeChoice() {
    var spanNode = document.getElementById("choice");
    //检查不能为空
        if (!document.getElementById("user_identity_basic").checked && !document.getElementById("user_identity_admin").checked) {
            spanNode.innerHTML = "请填写身份".fontcolor("red");
            return false;
        }
        else {
            return true;
...
function checkPersonalName() {
    ...
    if (document.getElementById("switcher1").className != "switcher1_active") {
        if(pNameLength > 10){
            spanNode.innerHTML = "姓名太长".fontcolor("red");
            return false;
        }
        else if (content == "" || pNameLength <= 0) {
...
function checkInstitute() {
    ...
    var content = inputNode.value;
    if (document.getElementById("switcher1").className != "switcher1_active") {
        if(instituteLength > 20){
            spanNode.innerHTML = "学院名称太长".fontcolor("red");
            return false;
        }
        else if (content == "" || instituteLength <= 0) {
...
function checkClass() {
    ...
    var content = inputNode.value;
    if (document.getElementById("switcher1").className != "switcher1_active") {
        if(instituteLength > 10){
            spanNode.innerHTML = "班级名称过长".fontcolor("red");
            return false;
        }
        else if (content == "" || instituteLength <= 0) {

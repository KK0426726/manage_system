    ...
    <div class="body">
        ...
        <div class="box">
            <div class="subnav">
                ...
                <div><a href="admin_2_add_admin.php" class="subnavlink_selected">管理员管理</a></div>
                        ...
                        <table class="altrowstable" id="alternatecolor">
                            ...
                            <?php
                                foreach($data as  $value){
                                    ...
                                    $sqll="SELECT * FROM gly WHERE name='{$arr['user_no']}'";
                                   ...
                                   if($data){echo "<td><a href='remove_admin.php?user_no={$arr['user_no']}'>移除管理员权限</a></td>";}
                                   else{ echo "<td><a href='grant_admin.php?user_no={$arr['user_no']}'>授予管理员权限</a></td>";}
                                    echo "</tr>";
                                }
                                mysqli_close($conn);
                            ?>
